...
CMD="python3.6 ./multiproc.py --nproc_per_node 1 ./main.py $OUT_DIR --raport-file raport.json -j8 -p 100 --data-backend syntetic --arch resnext101-32x4d -c fanin --label-smoothing 0.1 --workspace $OUT_DIR -b 128 --amp --static-loss-scale 128 --lr 1.024 --mom 0.875 --lr-schedule cosine --epochs  90 --warmup 8 --wd 6.103515625e-05 --memory-format nhwc"
